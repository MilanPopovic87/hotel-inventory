...
('demo', '$2a$10$ljwIPHLqr/VDtOQGEsGyueLwBkWg2zDy1kVp3VKJOCJehg3C7HNe6', 'USER'),
...
-- ROOMS
-- =========================
INSERT INTO room (name, type, price, available) VALUES
('Room 101', 'STANDARD', 60.00, true),
...
INSERT INTO booking (check_in_date, check_out_date, user_id, room_id) VALUES
('2026-05-10', '2026-05-12', 1, 1),
('2026-05-15', '2026-05-18', 2, 2),
('2026-05-20', '2026-05-22', 3, 3),
('2026-06-01', '2026-06-05', 4, 7),
('2026-06-10', '2026-06-12', 5, 8),
('2026-07-05', '2026-07-08', 1, 4);